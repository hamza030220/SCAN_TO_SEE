...
final class Version20260804100000 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE menu_hero (id INT AUTO_INCREMENT NOT NULL, menu_id INT NOT NULL, draft_config JSON NOT NULL, published_config JSON DEFAULT NULL, published_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_99819EC8CCD7E912 (menu_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE menu_hero ADD CONSTRAINT FK_99819EC8CCD7E912 FOREIGN KEY (menu_id) REFERENCES menu (id) ON DELETE CASCADE');
    }
